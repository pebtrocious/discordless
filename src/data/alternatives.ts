...
export const alternatives: Alternative[] = [
	...
	},
	{
		...
		pros: [
			...
			'Advanced permission system for granular control',
			'Custom CSS theme support in clients',
			'Stereo sound output ideal for music playback',
			'Unlimited file transfer functionality',
			'Screen sharing is available in beta on newer clients',
		],
		cons: [
			'Not open-source; the client and server are proprietary',
			'Dated UI',
